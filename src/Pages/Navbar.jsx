...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary text-primary-foreground border-b border-b-slate-300">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <a href="/" className="flex-shrink-0 flex items-center">
              ...
              <strong className="font-semibold">Container Overflow</strong>
            </a>
            ...
            <div className="ml-4 flex items-center md:ml-6">
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="Search..."
                  className="w-64 px-4 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-400-foreground"
                />
              </div>
              <button
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-primary text-primary-foreground z-50 flex justify-end">
          <div className="bg-primary w-64 h-full p-6">
